...
const PRESENTATION: Record<string, string> = {
  ...
  'level1-13-nesting': 'card',
  'level1-14-nesting-guided': 'truth-table-live',
  'level1-15-translate': 'card',
  'level2-01-nesting': 'card',
  'level2-02-double-neg': 'card',
  'level2-03-double-neg-watch': 'truth-table-multi',
  'level2-04-double-neg-guided': 'truth-table-live',
  'level2-05-precedence': 'card',
  ...
  'eval-011': 'truth-table-live',
  'eval-012': 'truth-table-live',
  'eval-013': 'truth-table-live',
  'eval-014': 'truth-table-live',
  'eval-015': 'truth-table-live',
  'eval-016': 'truth-table-live',
  'eval-017': 'truth-table-live',
  'eval-018': 'truth-table-live',
  'eval-019': 'truth-table-live',
  'eval-020': 'tree-eval',
  'eval-021': 'tree-eval',
  'eval-022': 'tree-eval',
  'scope-013': 'tree-scope',
  'scope-014': 'tree-scope',
  'tt-006': 'truth-table-partial',
  'counter-005': 'tree-eval',
  ...
  'lat-empty-no-counterexample': 'card',
  'lat-name-vacuity': 'card',
  'lat-conditional-meaning': 'card',
  'lat-conditional-notation': 'card',
  'lat-universal-meaning': 'card',
  'lat-quantifier-universal': 'card',
  'lat-existential-meaning': 'card',
  'lat-name-existential': 'card',
  'lat-quantifier-existential': 'card',
  'lat-existential-conjunction': 'card',
  'lat-ii-26-return': 'card',
  'lat-predict-empty-club': 'choice',
