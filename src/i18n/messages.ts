...
const EXERCISE_COPY: Record<Locale, Record<string, ExerciseCopy>> = {
  en: {
    ...
    'tt-001': { prompt: 'The table is almost complete. Choose True or False for the missing entry of P ∧ Q when P is true and Q is false.', cellCorrect: 'Correct — conjunction requires both conjuncts to be true.', cellWrong: 'Under this assignment, P is true and Q is false, so P ∧ Q is false.' },
  ...
  fr: {
    ...
    'tt-001': { prompt: 'Le tableau est presque complet. Choisissez Vrai ou Faux pour la case manquante de P ∧ Q lorsque P est vrai et Q est faux.', cellCorrect: 'Exact — une conjonction exige que les deux conjoints soient vrais.', cellWrong: 'Sous cette interprétation, P est vrai et Q est faux, donc P ∧ Q est faux.' },
    ...
    'nd-002': { prompt: 'Complétez la démonstration : choisissez l\'élimination de la conjonction et citez la ligne qui justifie P.', feedback: { correct: 'Exact — de P ∧ Q on obtient le conjoint gauche P par élimination de ∧.', incomplete: 'Sélectionnez ∧E, puis touchez la ligne contenant la conjonction.', 'wrong-rule-for-premises': '∧E exige une conjonction sur la ligne citée.', 'wrong-citation': 'Citez la ligne 1, la conjonction P ∧ Q.', 'conclusion-does-not-follow': 'Cette étape ne produit pas P à cette ligne.' } },
  },
};
