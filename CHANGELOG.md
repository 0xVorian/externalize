...
- Translation skill label is locale-neutral (`Prose to formula` / `Énoncé → formule`) while retaining the persisted `practice:translate-en-to-formula` skill id for backward compatibility
